...
async function main(): Promise<void> {
  ...
  console.log(`[AUTH] ${existingSessions.length} persisted session(s) loaded from ${SESSIONS_FILE}`);
  ...
  // Serve built UI, fall back to public/
  ...
  if (distPath) {
    ...
    console.log(`[STATIC] Serving UI build from ${distPath}`);
  } else if (publicPath) {
