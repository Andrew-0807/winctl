...
/* after */
.shell {
  grid-template-columns: auto 1fr; /* aside width drives this column */
}
/* .shell.sidebar-collapsed removed — no longer needed */
```
...
/* after */
aside {
  width: 240px;        /* was 220 — matches grid column expectation */
